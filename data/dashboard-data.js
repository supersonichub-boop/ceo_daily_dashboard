...
const DASHBOARD_DATA = {
  ...
  tasks: [
    ...
    { title: "ติดตามงานเพิ่มเอกสาร C ( พี่วาสิฏกำลังดำเนินการ ) ต้องเสร็จต้นสัปดาห์หน้า", status: "amber" },
  ...
  risks: [
    ...
    },
    {
      level: "amber",
      title: "ลูกหนี้ WLY",
      overdue: 4970820.43   // ค้างชำระ (บาท) ใส่ 0 เพื่อซ่อน
    },
    {
      level: "red",
