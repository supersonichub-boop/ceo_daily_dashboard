...
const DASHBOARD_DATA = {
  ...
  // ── CASH & LIQUIDITY ────────────────────────────────
  cash: {
    current:   3527.00,          // เงินสดคงเหลือ
    inflow7d:  400000.00,        // เงินเข้าคาดการณ์ 7 วัน
    outflow7d: 350000.00,        // เงินออกคาดการณ์ 7 วัน
  ...
  tasks: [
    ...
    { title: "ติดต่อสำเนาโฉนดที่ดินคุณอันและสัญญาฉบับแก้ไข" },
    { title: "ติดต่อสอบถามเรื่องคดีปลอมแปลงเอกสาร ปปช ภาค 8" },
    { title: "ติดตามงานเพิ่มเอกสาร C ( พี่วาสิฏกำลังดำเนินการ ) เร่งรัด" },
    { title: "ติดตามหนังสือจากเทศบาลศรีสุนทร (โทรสอบถาม)" },
    { title: "ทำอัปเดตรายงานต้นทุนอาคาร C (เริ่มทำไปด้วย)" },
    { title: "เตรียมเอกสารทางบัญชีให้พี่กิ่ง" },
    { title: "บันทึกข้อมูลค่าใช้จ่ายให้ครบและถูกต้อง" },
    { title: "ค่าใช้จ่ายรอจ่าย 2 บริษัท" },
    { title: "ทำรายงานเอกสารรับรอง" },
    { title: "ตามเงินค่าเช่าห้องคนงานจากพี่วาสิฏ" },
    { title: "ตามเงินค่างวดของ Wallaya" },
    { title: "ตามเงินของอันดามันแอสเซท เค้าแจ้งจะจ่ายกลางเดือน" }
  ],
  ...
  decisionItems: [
    // ─ NZN ─
    { group: "NZN" },
    { label: "ค่าจ้างช่างทาสี",              amount: 9000.00 },
    { label: "ค่าบริการออกแบบ (พี่หมี) งวดที่ 4", amount: 41600.00 },
    // ─ QFC ─
    { group: "QFC" },
    { label: "หนี้เก่า CMI",                  amount: 10000.00 },
    { label: "หนี้เก่าคอนกรีต TPI",           amount: 20000.00 },
    { label: "ย่าตุ๊",                         amount: 30000.00 },
    { label: "โคกคลอย",                        amount: 20000.00 },
    { label: "เชิงทะเล",                        amount: 10000.00 },
    { label: "ฉลองคอนกรีต (CLC)",             amount: 0 },
    { label: "หนี้เก่าพี่ยุ้ย",               amount: 10000.00 },
    { label: "ประกันสังคม MD",                 amount: 1500.00 },
    { label: "ค่าทนายเบียร์",                  amount: 10000.00 },
    { label: "หนี้อันดามันโฮมแมททีเรียล",     amount: 4000.00 },
    { label: "ค่าเช่าที่ดิน",                  amount: 36000.00 },
    { label: "ค่าแรงคนงาน 16-31 ส.ค. 69",    amount: 175573.00 },
    { label: "ค่าบริการรถเครน 25 ตัน 1/9/69", amount: 7280.00 },
  ...
  appointments: [
    // { time: "11.00น.", title: "ประชุมออนไลน์" }
    // เพิ่มนัดตรงนี้
  ],
