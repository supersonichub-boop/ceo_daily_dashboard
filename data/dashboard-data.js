...
const DASHBOARD_DATA = {
  ...
  tasks: [
    ...
    { title: "ติดต่อสำเนาโฉนดที่ดินคุณอันและสัญญาฉบับแก้ไข", status: "red" },
    ...
    { title: "เตรียมเอกสารทางบัญชีให้พี่กิ่ง", status: "amber" },
    { title: "บันทึกข้อมูลค่าใช้จ่ายให้ครบและถูกต้อง", status: "red" },
    { title: "ค่าใช้จ่ายรอจ่าย 2 บริษัท", status: "green" },
    { title: "หนังสือไปสภาสถาปนิก", status: "red" },
    { title: "ตามเงินค่าเช่าห้องคนงานจากพี่วาสิฏ", status: "red" },
    { title: "ตามเงินค่างวดของ Wallaya", status: "red" },
